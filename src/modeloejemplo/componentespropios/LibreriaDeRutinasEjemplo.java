...
public class LibreriaDeRutinasEjemplo extends LibreriaDeRutinas {
	...
	public ArrayList tiempoDeProcesamiento(int clase) {
		...
		if (clase == 1) {
			...
			else if (random < 0.90) {list.add(tiempoProcBebidas * 0.10f + tiempoProcBebidas); list.add(2);}
			else {list.add(tiempoProcBebidas * 0.13f + tiempoProcBebidas); list.add(3);}
		}else if(clase == 2) {
			double random = Math.random();
			if (random < 0.27) {list.add(tiempoProcPanaderia); list.add(1);}
			else if (random < 0.52) {list.add(tiempoProcPanaderia * 0.12f + tiempoProcPanaderia); list.add(2);}
			else if (random < 0.87) {list.add(tiempoProcPanaderia * 0.15f + tiempoProcPanaderia); list.add(3);}
			else {list.add(tiempoProcPanaderia * 0.20f + tiempoProcPanaderia); list.add(4);}
		}
		return list;
	}
